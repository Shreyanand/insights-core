...
Examples:
    >>> EXPORTS='''
    ... /home/utcs/shared/ro @rht(ro,sync)   ins1.redhat.com(rw,sync,no_root_squash) ins2.redhat.com(rw,sync,no_root_squash)
    ... /home/insights/shared/rw @rht(rw,sync)   ins1.redhat.com(rw,sync,no_root_squash) ins2.redhat.com(ro,sync,no_root_squash)
    ... /home/insights/shared/special/all/mail   @rht(rw,sync,no_root_squash)
    ... /home/insights/ins/special/all/config   @rht(ro,sync,no_root_squash)  ins1.redhat.com(rw,sync,no_root_squash)
    ... #/home/insights ins1.redhat.com(rw,sync,no_root_squash)
    ... /home/redhat           @rht(rw,sync,root_squash) ins1.redhat.com(rw,sync,no_root_squash) ins2.redhat.com(rw,sync,no_root_squash)
    ...
    set(['/home/insights/shared/rw', '/home/insights/ins/special/all/config', '/home/insights/shared/special/all/mail', '/home/redhat', '/home/utcs/shared/ro'])
"""
