...
class SystemctlShowPulpWorkers(SystemctlShow):
    ...
    Examples:
        >>> SrvPulpworkers = shared[SystemctlPulpWorkers]
        >>> SrvPulpworkers["After"]
        system.slice network.target systemd-journald.socket basic.target
    """
    pass


@parser('systemctl_pulp_resource_manager')
class SystemctlShowPulpResourceManager(SystemctlShow):
    ...
    Examples:
        >>> SrvPulpResourceManager = shared[SystemctlPulpResourceManager]
        >>> SrvPulpResourceManager["After"]
        -.mount systemd-journald.socket basic.target system.slice network.target
    """
    pass
...
class SystemctlShowPulpCelerybeat(SystemctlShow):
    ...
    Examples:
        >>> SrvPulpCelerybeat = shared[SystemctlPulpCelerybeat]
        >>> SrvPulpCelerybeat["After"]
        basic.target system.slice network.target -.mount systemd-journald.socket
    """
    pass
