from insights.mappers import uname
...
class TestUname(unittest.TestCase):
    ...
    def test_fixed_by_rhel5(self):
        test_kernels = [
            (uname.Uname.from_uname_str("Linux oprddb1r5.circoncorp.com 2.6.18-348.el5 #1 SMP Wed Nov 28 21:22:00 EST 2012 x86_64 x86_64 x86_64 GNU/Linux"), []),
            (uname.Uname.from_uname_str("Linux srspidr1-3.expdemo.com 2.6.18-402.el5 #1 SMP Thu Jan 8 06:22:34 EST 2015 x86_64 x86_64 x86_64 GNU/Linux"), []),
