from insights.mappers.nfs_exports import NFSExports, NFSExportsD
from insights.tests import context_wrap

EXPORTS = """
/home/utcs/shared/ro @rhtttttttttttt(ro,sync)   ins1.redhat.com(rw,sync,no_root_squash) ins2.redhat.com(rw,sync,no_root_squash)
/home/insights/shared/rw @rhtttttttttttt(rw,sync)   ins1.redhat.com(rw,sync,no_root_squash) ins2.redhat.com(ro,sync,no_root_squash)
/home/insights/shared/special/all/mail   @rhtttttttttttt(rw,sync,no_root_squash)
/home/insights/ins/special/all/config   @rhtttttttttttt(ro,sync,no_root_squash)  ins1.redhat.com(rw,sync,no_root_squash)
#/home/insights ins1.redhat.com(rw,sync,no_root_squash)
/home/redhat           @rhtttttttttttt(rw,sync,root_squash) ins1.redhat.com(rw,sync,no_root_squash) ins2.redhat.com(rw,sync,no_root_squash)
/home/redhat           ins3.redhat.com(rw,sync,no_root_squash)
""".strip()
...
def _do(nfs_exports):
    assert nfs_exports.data == {
        "/home/utcs/shared/ro": {
            ...
            "ins1.redhat.com": ["rw", "sync", "no_root_squash"],
            "ins2.redhat.com": ["rw", "sync", "no_root_squash"]
        }, "/home/insights/shared/rw": {
            "@rhtttttttttttt": ["rw", "sync"],
            "ins1.redhat.com": ["rw", "sync", "no_root_squash"],
            "ins2.redhat.com": ["ro", "sync", "no_root_squash"]
    ...
    assert nfs_exports.export_paths() == set([
        ...
        "/home/insights/shared/special/all/mail",
        "/home/insights/ins/special/all/config", "/home/redhat"
    ])
