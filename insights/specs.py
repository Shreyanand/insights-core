...
jboss_domain_config = sf.foreach_collect(jboss_domain_config_files, "%s", name="jboss_domain_config")
...
jboss_domain_pid_conf_map = sf.foreach_execute(jboss_domain_pid_conf_maps, "echo %s", name="jboss_domain_pid_conf_map")
